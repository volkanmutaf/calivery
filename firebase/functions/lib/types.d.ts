...
export type EventType = 'order_created' | 'assigned' | 'system_route_generated' | 'pickup_photo_uploaded' | 'picked_up' | 'delivery_photo_uploaded' | 'delivered' | 'reassigned' | 'cancelled';
