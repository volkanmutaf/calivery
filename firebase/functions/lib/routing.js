...
exports.ALGORITHM_VERSION = void 0;
exports.haversineDistance = haversineDistance;
exports.getWeekStartDate = getWeekStartDate;
exports.findBestDriverForOrder = findBestDriverForOrder;
exports.generateRouteSteps = generateRouteSteps;
 ...
 */
async function getDriverWeeklyEarnings(db, driverId) {
    ...
    return doc.data().total_earnings || 0;
}
/**
 * Get driver's current active step count
 */
async function getDriverActiveSteps(db, driverId) {
 ...
 */
async function findBestDriverForOrder(db, order, candidateLimit = 5) {
    ...
    for (const doc of driversSnap.docs) {
        ...
        const distance = haversineDistance(profile.driver_base_lat, profile.driver_base_lng, order.pickup_lat, order.pickup_lng);
 ...
 */
function generateRouteSteps(driverBaseLat, driverBaseLng, orders) {
    // Create nodes for all pickups and dropoffs
    const pickupNodes = orders.map(order => ({
